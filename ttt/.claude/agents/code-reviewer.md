...
[WORKFLOW_STATUS]
status: READY
context: Code review APPROVED - no issues found
next_hint: tester should run tests
===============================================================
```
...
[WORKFLOW_STATUS]
status: BLOCKED
context: Code review found N issues (H high, M medium, L low)
next_hint: code-editor should fix issues
===============================================================
```
...
1. [HIGH] `src/core/user_service.cpp:45`
   - Problem: raw pointer usage, memory leak risk
   - Suggestion: use std::unique_ptr

2. [MEDIUM] `qml/components/UserCard.qml:23`
   - Problem: id not defined
   - Suggestion: add `id: root`

3. [LOW] `src/core/user_service.h:12`
   - Problem: [[nodiscard]] missing
   - Suggestion: add [[nodiscard]] to getter
...
[WORKFLOW_STATUS]
status: BLOCKED
context: 3 issues found (1 high, 1 medium, 1 low)
next_hint: code-editor should fix issues
===============================================================
```
